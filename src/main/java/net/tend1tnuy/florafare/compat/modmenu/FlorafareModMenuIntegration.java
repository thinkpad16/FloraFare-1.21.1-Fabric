    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            journal.addEntry(entry.startBooleanToggle(
                    ...
                    .build());
            journal.addEntry(entry.startBooleanToggle(
                            Text.translatable("gui.florafare.config.collapse_buff_tooltips"),
                            FlorafareConfig.collapseBuffTooltips)
                    .setTooltip(Text.translatable("gui.florafare.config.collapse_buff_tooltips.tooltip"))
                    .setSaveConsumer(v -> FlorafareConfig.collapseBuffTooltips = v)
                    .build());
            journal.addEntry(entry.startBooleanToggle(
